 ...
 *
 * @brief <b>libopencm3 STM32WB5x FLASH</b>
 *
 * @version 1.0.0
 *
 ...
 *
 * This library supports the FLASH memory controller in the STM32WB5
 * series of ARM Cortex Microcontrollers by ST Microelectronics.
 *
 * For the STM32WB5x, accessing FLASH memory is described briefly in
 * section 3 of the STM32WB5x Reference Manual.
 *
